# Matrix CLI Documentation Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Create `docs/MATRIX_CLI.md` with a complete command reference and add a "For Plugin Developers" section to `README.md`.

**Architecture:** Two-file change. New standalone doc follows the pattern of every other file in `docs/`. README gets a collapsed `<details>` block added just before the final sign-off line.

**Tech Stack:** Markdown only — no code changes.

---

### Task 1: Create docs/MATRIX_CLI.md

**Files:**
- Create: `docs/MATRIX_CLI.md`
...
Open `docs/MATRIX_CLI.md` in a markdown viewer or just confirm it exists:
```bash
wc -l docs/MATRIX_CLI.md
```
Expected: ~200+ lines
...
```bash
git add docs/MATRIX_CLI.md docs/plans/2026-03-01-matrix-cli-docs.md docs/plans/2026-03-01-matrix-cli-docs-design.md
git commit -m "docs: add Matrix CLI reference (docs/MATRIX_CLI.md)"
```
...
**Files:**
- Modify: `README.md` (just before the final "If you've read this far" line)

**Step 1: Add the "For Plugin Developers" section**
...
```bash
git add README.md
git commit -m "docs: mention matrix CLI in README"
```
