...
class PluginManager:
    ...
    def __init__(
        ...
        try:
            ...
            raise PluginError(
                f"Could not create plugins directory: {self.plugins_dir}", context={"error": str(e)}
            ) from e
    ...
    def discover_plugins(self) -> List[str]:
        ...
        for collision in collisions:
            self.logger.warning("Config collision detected: %s", collision.get("message", str(collision)))
    ...
    def load_plugin(self, plugin_id: str) -> bool:
        ...
        try:
            ...
            plugin_dir = self.plugin_loader.find_plugin_directory(plugin_id, self.plugins_dir, plugin_directories)
