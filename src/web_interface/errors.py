...
class WebInterfaceError:
    ...
    def _get_default_suggestions(self, error_code: ErrorCode) -> List[str]:
        ...
        suggestions_map = {
            ...
            ErrorCode.TIMEOUT: ["Retry the operation", "Check network connection", "Verify service is responding"],
        }
    ...
    @classmethod
    def from_exception(
        cls, exception: Exception, error_code: Optional[ErrorCode] = None, context: Optional[Dict[str, Any]] = None
    ) -> "WebInterfaceError":
        """
