...
class DisplayHelper:
    ...
    def create_base_image(self, background_color: Tuple[int, int, int] = (0, 0, 0), mode: str = "RGB") -> Image.Image:
        """
    ...
    def draw_scorebug_layout(
        self,
        game_data: Dict[str, Any],
        fonts: Dict[str, ImageFont.ImageFont],
        home_logo: Optional[Image.Image] = None,
        away_logo: Optional[Image.Image] = None,
    ) -> Image.Image:
        """
    ...
    def draw_ticker_layout(
        ...
        # Draw text
        self._draw_text_with_outline(draw, text, (x_position, self.display_height // 2 - 6), font, fill=text_color)
    ...
    def _draw_centered_text(
        self, draw: ImageDraw.ImageDraw, text: str, font: ImageFont.ImageFont, y_position: int
    ) -> None:
