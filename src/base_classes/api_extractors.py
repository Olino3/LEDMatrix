...
class ESPNBaseballExtractor(APIDataExtractor):
    ...
    def get_sport_specific_fields(self, game_event: Dict) -> Dict:
        ...
        try:
            ...
            sport_fields = {"inning": "", "outs": 0, "bases": "", "strikes": 0, "balls": 0, "pitcher": "", "batter": ""}
                ...
                sport_fields.update(
                    {
                        ...
                        "shots_on_goal": {"home": situation.get("homeShots", 0), "away": situation.get("awayShots", 0)},
                    }
                )
