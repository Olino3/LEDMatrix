    ...
    def _test_mode_update(self):
        if self.current_game and self.current_game["is_live"]:
            try:
                ...
                if seconds % 15 == 0:
                    self.current_game["down_distance_text"] = (
                        f"{['1st', '2nd', '3rd', '4th'][seconds % 4]} & {seconds % 10 + 1}"
                    )
            ...
            if self.display_height >= 24:
                ...
                if scoring_event and game.get("is_live"):
                    ...
                    self._draw_text_with_outline(
                        draw_overlay, scoring_event, (event_x, event_y), self.fonts["detail"], fill=event_color
                    )
                    ...
                    self._draw_text_with_outline(
                        draw_overlay, down_distance, (dd_x, dd_y), self.fonts["detail"], fill=down_color
                    )
                        ...
                        if ball_x_center > 0:  # Draw if position is valid
                            ...
                            draw_overlay.ellipse(
                                (
                                    ...
                                    ball_y_center - ball_radius_y,  # x0, y0
                                    ball_x_center + ball_radius_x,
                ...
                for i in range(3):
                    ...
                    )  # White if available, gray if used
