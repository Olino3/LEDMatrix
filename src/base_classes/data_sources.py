...
class DataSource(ABC):
    ...
    def get_headers(self) -> Dict[str, str]:
        ...
        return {"User-Agent": "LEDMatrix/1.0", "Accept": "application/json"}
...
class MLBAPIDataSource(DataSource):
    ...
    def fetch_live_games(self, sport: str, league: str) -> List[Dict]:
        ...
        try:
            ...
            # Filter for live games
            live_games = [game for game in games if game.get("status", {}).get("abstractGameState") == "Live"]
...
class SoccerAPIDataSource(DataSource):
    ...
    def fetch_live_games(self, sport: str, league: str) -> List[Dict]:
        ...
        try:
            ...
            params = {"status": "LIVE", "competition": league}
